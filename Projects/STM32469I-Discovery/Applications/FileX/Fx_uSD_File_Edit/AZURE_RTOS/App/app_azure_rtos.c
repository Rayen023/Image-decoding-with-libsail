...
static UCHAR sail_byte_pool_buffer[16 * 1024];
TX_BYTE_POOL sail_byte_pool;

/* USER CODE BEGIN PV */
/*
UCHAR sail_byte_pool_buffer[8 * 1024];
TX_BYTE_POOL sail_app_byte_pool ;
...
VOID tx_application_define(VOID *first_unused_memory)
{
  ...
  VOID *memory_ptr;
  if (tx_byte_pool_create(&sail_byte_pool, "Tx App memory pool", sail_byte_pool_buffer, 16 * 1024) != TX_SUCCESS)
  {
